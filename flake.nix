{
  ...
  inputs = {
    ...
    logos-delivery.url = "git+https://github.com/logos-messaging/logos-delivery?submodules=1&ref=poc-discovery-plugin-9&rev=57a7ffc6f13e8ca87fa34fec6a8983cd47ba549a";
