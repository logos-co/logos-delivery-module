{
  ...
  inputs = {
    ...
    logos-delivery.url = "git+https://github.com/logos-messaging/logos-delivery?submodules=1&ref=poc-discovery-plugin-9&rev=67b05442e03a8c868ba486efacb8a40d6a6f4ae7";
