{
  ...
  inputs = {
    ...
    logos-delivery.url = "git+https://github.com/logos-messaging/logos-delivery?submodules=1&ref=feat/mix-rln-module-interop&rev=32dcc726d3342ab4795abf6db50edd07b7f880bd";
