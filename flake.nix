{
  ...
  inputs = {
    ...
    logos-delivery.url = "git+https://github.com/logos-messaging/logos-delivery?submodules=1&ref=poc-discovery-plugin-9&rev=54bfc6937108cf5e18b5d782964e8eefdd83339a";
