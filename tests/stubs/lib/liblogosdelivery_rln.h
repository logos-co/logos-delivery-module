// Mirrors library/liblogosdelivery_rln.h from logos-delivery
// (impl-plugable-rln-api-module d372cd3). Keep in sync with the real
// header when bumping the logos-delivery flake input.
#pragma once
