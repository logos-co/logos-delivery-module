...
// The provider name logos-core routes by, and the name the backend registers under.
inline constexpr const char* kDefaultLibp2pProvider = "libp2p_module";
...
public:
    ...
    StdLogosResult start(std::shared_ptr<Libp2pTransport> transport, const std::string& provider);
